...
tbl_ohp <- tibble::tibble(Nr = c(1, 2, 3, 4, 5, 6, 7),
                          ...
                          Topic = c(
                              ...
                              paste0("[Single Locus Breeding Values](", s_ohp_url, "20221007_ohp_l03.pdf)", collapse = ""),
                              paste0("[Genetic Evaluation](", s_ohp_url, "20221014_ohp_l04.pdf)", collapse = ""),
                              paste0("[Repeated Records and Progeny](", s_ohp_url, "20221021_ohp_l05.pdf)", collapse = ""),
                              paste0("[Linear fixed effects models and linear mixed effects models](", s_ohp_url, "20221028_ohp_l06.pdf)", collapse = ""),
                              paste0("[Sire model, animal model and numerator relationship matrix](", s_ohp_url, "20221104_ohp_l07.pdf)", collapse = "")
                            ))
knitr::kable(tbl_ohp)
```
...
tbl_data <- tibble::tibble(Nr = c(1,2,3,4,5,6),
