...
# data url
s_data_url_path <- "https://charlotte-ngs.github.io/lbgfs2022/data/geno_data.csv"
```
...
if (n_min_eig_matG_start < sqrt(.Machine$double.eps))
  stop(" *** Genomic relationship matrix singular with smallest eigenvalue: ", n_min_eig_matG_start)
```
