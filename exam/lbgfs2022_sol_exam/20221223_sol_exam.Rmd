...
n_alpha <- n_homo_geno_val + (1 - 2*n_maf_locus_w) * n_het_geno_val
n_add_gen_var_base_pop <- 2 * n_maf_locus_w * (1-n_maf_locus_w) * n_alpha^2
...
For the entries in the table below, the following values were used

* allele substitution $\alpha = `r n_alpha`$
* genetic additive variance in base population $V_U = `r n_add_gen_var_base_pop`$
* inbreeding coefficient $F = `r n_F_t_limit`$
